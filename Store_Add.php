...
<?php
    ...
    $in = "INSERT INTO `products`(`ItemName`, `ItemDescription`, `Quantity In Stock`, `Price`, `Visible`, `Category`, `SubCategory`, `Picture`) VALUES ('$name','$discription','$quan','$price','$vis','$category','$sub','$image')";
	echo $image;
